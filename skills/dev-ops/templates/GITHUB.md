...
Você **não precisa entender git** pra usar este projeto. O Forger cuida disso.
...
se algo quebrar, você descobre **qual commit** quebrou e volta só ele. O Forger
...
está verde e revisado, você faz **merge** (junta na `main`). No Forger, o
...
O resto — branch, merge, CI — o Forger e o GitHub fazem por baixo. Você fala a
